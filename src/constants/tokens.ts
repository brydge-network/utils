...
export const MATIC_NATIVE_ADDRESS =
...
} as { [chainId in SupportedChainId]: Token };
...
export const STARGATE_CURRENCIES: TokenMap = {
  [SupportedChainId.OPTIMISM]: USDC_OPTIMISM,
  [SupportedChainId.ARBITRUM_ONE]: USDC_ARBITRUM,
  [SupportedChainId.MAINNET]: USDC_MAINNET,
  [SupportedChainId.POLYGON]: USDC_POLYGON,
...
export function isNativeAddress(address: string, chainId: number): boolean {
  ...
  if (chainId === SupportedChainId.POLYGON && address === MATIC_NATIVE_ADDRESS)
    return true;
...
export const DAI_LIST: { [chainId: number]: Token } = {
  1: DAI,
  42161: DAI_ARBITRUM_ONE,
  10: DAI_OPTIMISM,
  43114: DAI_AVALANCHE,
  137: DAI_POLYGON,
};
