...
export interface TestMultichainPortalInterface extends utils.Interface {
  functions: {
    ...
    "processRequest(address,uint256,bytes)": FunctionFragment;
...
export interface TestMultichainPortal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestMultichainPortalInterface;
  ...
  functions: {
    ...
    processRequest(
      ...
      rawRequestData: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
